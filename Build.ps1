...
$Manifest = @{
    ...
    Description = 'IO.Swagger - the PowerShell module for Demo Client for Passmeister Apple Wallet and Google Wallet API'

    RootModule = 'IO.Swagger.psm1'
    Guid = '{24F0CEEF-6E85-4956-92FC-A6CC12192AE1}' # Has to be static, otherwise each new build will be considered different module
